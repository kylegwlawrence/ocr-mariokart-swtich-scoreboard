...
if __name__=="__main__":
    # init the stupid service
    svc = DataService()

    # merge the predictions csv files
    svc.merge_csv_files(input_folder="outputs/predictions/data", output_path="outputs/predictions/analysis/PREDS.csv")

    # flatten config column and save
    process_csv("outputs/predictions/analysis/PREDS.csv", "outputs/predictions/analysis/CLEAN.csv")